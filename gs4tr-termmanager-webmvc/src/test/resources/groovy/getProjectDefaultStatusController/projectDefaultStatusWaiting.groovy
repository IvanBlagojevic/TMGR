package groovy.getProjectDefaultStatusController
...
projectInfo = builder.projectInfo([clientIdentifier: null, enabled: true, name: "Nikon", shortCode: "NIKON0001"])
...
tmProject = builder.tmProject([addApprovedTerms: false, announcements: null, attributes: null, defaultTermStatus: statusWaiting,
...
projectComboBox = [
    "4YESyxwCtA1Wj8ujUmCA18npTWF1uB/q"] as List