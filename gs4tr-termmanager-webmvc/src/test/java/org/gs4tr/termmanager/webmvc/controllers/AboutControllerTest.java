...
public class AboutControllerTest extends AbstractControllerTest {

    private static final String URL = "about.ter";

    @Test
    public void aboutDialogTest() throws Exception {
	MockHttpServletRequestBuilder get = MockMvcRequestBuilders.post("/" + URL);
	...
	JsonNode version = resultNode.get("version");
