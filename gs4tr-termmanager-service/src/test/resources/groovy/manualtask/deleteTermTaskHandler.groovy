...
termEntry02 = builder.termEntry([uuId: termEntryId_01, languageTerms: termEntryMap2, projectId: 1L])

command = builder.termCommandPerProject([termIds: termIds, termEntryIds: [termEntryId_01] as List, projectId: 1])

command1 = builder.termCommandPerProject([termEntryIds: [termEntryId_01] as List, projectId: 1])

commands = builder.deleteTermCommands([deleteCommands: [command] as List, targetLanguages: [deDE, frFR, itIT] as List, sourceLanguage: enUS])


commands1 = builder.deleteTermCommands([deleteCommands: [command1] as List, targetLanguages: [] as List, sourceLanguage: "", deleteTermEntries: true])