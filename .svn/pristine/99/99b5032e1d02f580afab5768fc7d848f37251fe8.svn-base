...
@TestSuite("glossary")
public class DoNotUpdateOverwriteIdenticalAttributesTest extends AbstractV2GlossaryServiceTest {

    @Test
    public void testDoNotUpdateOverwriteIdenticalAttributesTest() throws OperationsException {
	...
	request.add(term1);
	request.add(term2);
	request.setOption(UpdateOption.DONTOVERWRITE_WHEN_IDENTICAL_ATTRIBUTES);
