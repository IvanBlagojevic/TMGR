...
projectLanguage1 = builder.projectLanguage([language: "en-US", project: tmProject, projectLanguageId: 1L,
    default: false])
projectLanguage2 = builder.projectLanguage([language: "de-DE", project: tmProject, projectLanguageId: 2L,
    default: false])
projectLanguage3 = builder.projectLanguage([language: "fr-FR", project: tmProject, projectLanguageId: 3L,
    default: false])
projectLanguage4 = builder.projectLanguage([language: "en", project: tmProject, projectLanguageId: 4L,
    default: false])
...
projectLanguages = [
    ...
    projectLanguage2,
    projectLanguage3,
    projectLanguage4] as Set

tmProject.setProjectLanguages(projectLanguages)
...
policy6 = builder.policy([description: "Some policy description", policyId: "POLICY_TM_TERMENTRY_IMPORT",
    policyType: "CONTEXT", category: "Task"])
policy7 = builder.policy([description: "Some policy description", policyId: "POLICY_TM_TERM_VIEW_TERM_HISTORY",
    policyType: "CONTEXT", category: "Task"])
policy8 = builder.policy([description: "Some policy description", policyId: "POLICY_TM_TERMENTRY_EXPORT",
    policyType: "CONTEXT", category: "Task"])
...
projectUserLanguage2 = builder.projectUserLanguage([language: "de-DE", project: tmProject, projectUserLanguageId: 2L,
    statistics: null, user: null])
projectUserLanguage3 = builder.projectUserLanguage([language: "fr-FR", project: tmProject, projectUserLanguageId: 3L,
    statistics: null, user: null])

projectUserLanguages = [
    projectUserLanguage1,
    projectUserLanguage2,
    projectUserLanguage3] as List
