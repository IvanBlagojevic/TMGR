...
@TestSuite("glossary")
public class UpdateOverwriteIdenticalAttributesTest extends AbstractV2GlossaryServiceTest {

    @Test
    public void testUpdateOverwriteIdenticalAttributesTest() throws OperationsException {
	...
	request.add(term1);
	request.add(term2);
	request.setOption(UpdateOption.OVERWRITE_WHEN_IDENTICAL_ATTRIBUTES);
