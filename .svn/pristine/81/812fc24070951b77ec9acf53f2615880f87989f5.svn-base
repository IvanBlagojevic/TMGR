...
report = builder.fileAnalysisReport([importLanguageReport: importLanguageReport, importAttributeReport: importAttributeReport, termEntryIdExist: false])

userProjectLanguageCodes = [Locale.ITALIAN.getCode()] as Set