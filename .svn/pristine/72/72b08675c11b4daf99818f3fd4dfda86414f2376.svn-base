...
@TestSuite("glossary")
public class UpdateOverwriteBlacklistTest extends AbstractV2GlossaryServiceTest {

    @SuppressWarnings("unchecked")
    @Test
    @TestCase("blacklistSegmentSearch")
    public void testUpdateOverwrite() throws OperationsException {
	...
	request.add(term1);
	request.add(term2);
	request.setOption(UpdateOption.OVERWRITE);
