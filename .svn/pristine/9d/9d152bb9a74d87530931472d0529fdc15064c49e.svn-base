...
term2 = builder.term([uuId: termId_02, name: "test term 2", projectId: 1L, termEntryId: termEntryId_01, forbidden: true,
    status: "BLACKLISTED", languageId: "de-DE", inTranslationAsSource: false])
