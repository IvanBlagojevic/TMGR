...
public class ProjectDetailView  implements Serializable {
    ...
    private static final long serialVersionUID = 7576194772577490247L;
    private long _activeSubmissionCount;
    private long _approvedTermCount;
    private boolean _availableDescription;
    ...
    private long _projectDetailViewId;
    ...
    public long getProjectDetailViewId() {
	return _projectDetailViewId;
    }
    ...
    public boolean isAvailableDescription() {
    ...
    public void setProjectDetailViewId(long projectDetailViewId) {
	_projectDetailViewId = projectDetailViewId;
    }
