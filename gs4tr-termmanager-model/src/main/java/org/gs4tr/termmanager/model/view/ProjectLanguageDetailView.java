...
public class ProjectLanguageDetailView extends AbstractItemHolder implements Serializable {

    private static final long serialVersionUID = -5563437719832408702L;
    ...
    private long _pendingApprovalTermCount;
    ...
    private Long _projectLanguageDetailViewId;
	...
	return getProjectLanguageDetailViewId();
    }
    ...
    public long getPendingApprovalTermCount() {
	return _pendingApprovalTermCount;
    }

    public Long getProjectLanguageDetailViewId() {
	return _projectLanguageDetailViewId;
    }
    ...
    public void setPendingApprovalTermCount(long pendingApprovalTermCount) {
	_pendingApprovalTermCount = pendingApprovalTermCount;
    }

    public void setProjectLanguageDetailViewId(Long projectLanguageDetailViewId) {
	_projectLanguageDetailViewId = projectLanguageDetailViewId;
    }
