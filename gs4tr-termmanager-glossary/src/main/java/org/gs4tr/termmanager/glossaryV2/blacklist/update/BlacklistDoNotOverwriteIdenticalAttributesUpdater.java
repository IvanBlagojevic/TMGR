...
@Component("blacklistDoNotOverwriteIdenticalAttributesUpdater")
public class BlacklistDoNotOverwriteIdenticalAttributesUpdater implements BlacklistUpdater {

    @Override
    public BatchProcessResult update(BlacklistUpdateRequestExt request) {
	String message = String.format(Messages.getString("BlacklistDoNotOverwriteIdenticalAttributesUpdater.0"), //$NON-NLS-1$
