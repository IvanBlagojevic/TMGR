...
@Component("doNotOverwriteIdenticalAttributesUpdater")
public class DoNotOverwriteIdenticalAttributesUpdater implements GlossaryUpdater {

    @Override
    public BatchProcessResult update(GlossaryUpdateRequestExt request) {
	String message = String.format(Messages.getString("DoNotOverwriteIndenticalAttributesUpdater.1"), //$NON-NLS-1$
