...
projectInfo = builder.projectInfo([clientIdentifier: null, enabled: true, name: "Meddra", shortCode: "TES000001"])
...
role2 = builder.role([policies: policies2, roleId: "generic_user", roleType: "CONTEXT", generic: true])

roleOnHold = builder.role([policies: policiesBasic, roleId: "super_user", roleType: "CONTEXT", generic: false])

roles = [role1] as List

rolesGeneric = [role2] as List

rolesBasic = [roleOnHold] as List
